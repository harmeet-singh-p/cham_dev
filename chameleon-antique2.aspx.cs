...
{
    public partial class chameleon_antique2 : System.Web.UI.Page
    {
        ...
        private string sStatus = "(webEnabled = 1 and status <> 'Sold' or (status = 'Sold' and DATEDIFF (day,dateSold,getdate() ) <= 21))";
